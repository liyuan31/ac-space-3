...
ini.have_external_monitor = 0;          % Caution. If I test the code on my laptop set this to 1, otherwise set to 0.
ini.is_test_mode = 0;
...
datafilename = strcat('Data/Data_',ini.expname,'_',sub_no,'.csv');
stimfilename = strcat('Tracking/Stim_',ini.expname,'_',sub_no,'.csv');
